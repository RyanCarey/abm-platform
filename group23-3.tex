...
\usepackage{caption}
\usepackage{enumitem}
\usepackage[left=2.90cm, right=2.90cm, top=3.00cm, bottom=4.50cm]{geometry}
\usepackage{parskip}
...
%\bibitem{vincente05}
%  Vicente-Manzanares, Miguel, Donna J. Webb, and A. Rick Horwitz. ``Cell migration at a glance.'' {\itshape Journal of Cell Science} 118.21 (2005): 4917-4919.
%\newpage
%\begin{appendices}
%\end{appendices}
