function gui_ligand(v::Array, v2::Array,v3::Array, v4::Array, prompts2::Array, entries2::Array)
  ...
  for i in 1:v2[7] 
    ...
    formlayout(l,nothing) 
    if i <= length(v3)    # fill in any values that have previously been entered
    ...
    if i > length(v3)
      ...
      formlayout(entries3[end],string(prompts3[1],": ")) 
      formlayout(entries3[end],string(prompts3[2],": ")) 
